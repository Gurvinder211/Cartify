    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-4'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <select onChange={(e) => setCategory(e.target.value)} className="w-full px-3 py-2 h-10 border border-gray-300 rounded appearance-none">
        ...
        <div>
          ...
          <select onChange={(e) => setSubCategory(e.target.value)} className="w-full px-3 py-2 h-10 border border-gray-300 rounded appearance-none">
      ...
      <div>
        ...
        <div className="flex gap-3 ">
          <div onClick={() => setSizes(prev => prev.includes("S") ? prev.filter(size => size !== "S") : [...prev, "S"])}>
            <p className={sizes.includes("S") ? "bg-black text-white px-3 py-1 cursor-pointer" : "bg-slate-200 px-3 py-1 cursor-pointer"}>S</p>
          </div>
          <div onClick={() => setSizes(prev => prev.includes("M") ? prev.filter(size => size !== "M") : [...prev, "M"])}>
            <p className={sizes.includes("M") ? "bg-black text-white px-3 py-1 cursor-pointer" : "bg-slate-200 px-3 py-1 cursor-pointer"}>M</p>
          </div>
          <div onClick={() => setSizes(prev => prev.includes("L") ? prev.filter(size => size !== "L") : [...prev, "L"])}>
            <p className={sizes.includes("L") ? "bg-black text-white px-3 py-1 cursor-pointer" : "bg-slate-200 px-3 py-1 cursor-pointer"}>L</p>
          </div>
          <div onClick={() => setSizes(prev => prev.includes("XL") ? prev.filter(size => size !== "XL") : [...prev, "XL"])}>
            <p className={sizes.includes("XL") ? "bg-black text-white px-3 py-1 cursor-pointer" : "bg-slate-200 px-3 py-1 cursor-pointer"}>XL</p>
          </div>
          <div onClick={() => setSizes(prev => prev.includes("XXL") ? prev.filter(size => size !== "XXL") : [...prev, "XXL"])}>
            <p className={sizes.includes("XXL") ? "bg-black text-white px-3 py-1 cursor-pointer" : "bg-slate-200 px-3 py-1 cursor-pointer"}>XXL</p>
          </div>
        </div>
      </div>
